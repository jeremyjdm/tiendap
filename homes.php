...
// Verificar si el usuario ha iniciado sesión y si su perfil es de empleado
if (!isset($_SESSION['nombre_usuario']) || $_SESSION['perfil'] !== 'secretaria') {
    // Redirigir a la página de inicio de sesión si no es un empleado autenticado
